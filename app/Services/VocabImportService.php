...
class VocabImportService
{
    public function import(
        ...
        foreach ($data['vocabularies'] as $vocabData) {
            ...
            // Chapter automatisch erstellen, falls nicht vorhanden
    ...
    {
        $language = \App\Models\Language::where('slug', $code)->first();
        
        if (!$language) {
            // Sprache automatisch erstellen, falls nicht vorhanden
