<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('language.index')" :active="Str::startsWith(request()->url(), '/languages')">
                {{ __('general.languages') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('book.index')" :active="Str::startsWith(request()->url(), '/books')">
                {{ __('general.books') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('chapter.index')" :active="Str::startsWith(request()->url(), '/chapters')">
                {{ __('general.chapters') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('vocabulary.index')" :active="Str::startsWith(request()->url(), '/vocabularies')">
                {{ __('general.vocabularies') }}
            </x-responsive-nav-link>
        </div>
